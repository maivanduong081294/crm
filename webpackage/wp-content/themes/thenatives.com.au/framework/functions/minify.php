...
if(!is_user_logged_in() || !current_user_can('administrator')) {
    ...
    add_action('wp_head', 'thenatives_print_styles', 8);
    function thenatives_print_styles()
    {
        if (!is_admin()) {
    ...
    add_action('wp_footer', 'thenatives_print_scripts');
    function thenatives_print_scripts()
    {
